...
export default function Modal(
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col items-center top-2/4  overflow-x-auto rounded-lg model_table dark:model_table dark:text-gray-800 max-[450px]:w-[25rem] max-[400px]:w-[20rem] md:w-[40rem]">
