...
export const UserInfoProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    for (const permiso of userInfo?.userPermissions?.permisos ?? []) {
  ...
  }, [path, allPermisions, userInfo?.userPermissions?.permisos, userInfo?.roleInfo?.tipo_usuario, searchParams]);
